...
By the Feit--Thompson theorem, int he previous theorem 
...
As an application of The Schur--Zassenhaus theorem, we present Hall's theory of solvable groups. For an elementary presentation, see \cite{MR600654}. 
...
$G$ is a \textbf{$\pi$-grupo} if every prime dividing $|G|$ belongs to $\pi$. Similarly, a $\pi$-subgroup of $G$ is a subgroup of $G$ that is also a $\pi$-group.  
\end{definition}
